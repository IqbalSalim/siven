    ...
    return (
        <section className={className}>
            ...
            >
                <div className="grid gap-4 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <TextInput
                            ...
                            onChange={(e) =>
                                setData("nama_ormawa", e.target.value)
                            }
                            required
                            isFocused
                    ...
                    <div className="flex flex-row space-x-4">
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                className="block w-full mt-1"
                                onChange={(e) =>
                                    setData("gambar_profil", e.target.files[0])
                                }
                            />

                            <InputError
                                className="mt-2"
                                message={errors.gambar_profil}
                            />
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row space-x-4">
                        {user.ormawa.gambar_struktur && (
                            <div className="mb-4">
                                <img
                                    src={
                                        "storage/" + user.ormawa.gambar_struktur
                                    }
                                    className="w-16"
                                />
                            </div>
                        ...
                        <div>
                            <InputLabel
                                htmlFor="gambar_struktur"
                                value="Gambar Struktur"
                            />
                            ...
                            <InputError
                                className="mt-2"
                                message={errors.gambar_struktur}
                            />
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <InputLabel
                        htmlFor="tentang_ormawa"
                        value="Tentang Ormawa"
                    />
                    ...
                    <TextArea
                        ...
                        rows="8"
                        onChange={(e) =>
                            setData("tentang_ormawa", e.target.value)
                        }
                    ></TextArea>

                    <InputError
                        className="mt-2"
                        message={errors.tentang_ormawa}
                    />
                </div>
